<template>
  <div class="opening" :class="{ ready: isLoading }" v-if="isLoading">
    <div class="logo_01" :class="{ ready: isLoading }">
      <img src="/animation_logo.png" />
    </div>
    <div class="logo_02" :class="{ ready: isLoading }">
      <img src="/animation_text.svg" />
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    //console.log(mapGetters({ isLoading: "isLoading" }));
